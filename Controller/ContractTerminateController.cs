...
namespace HRCentral.Web.Controllers
{
    ...
    public class ContractTerminateController : Controller
    {
        ...
        private readonly ILogger<ContractTerminateController> _logger;
        ...
        public ContractTerminateController(
            ...
            ILogger<ContractTerminateController> logger,
